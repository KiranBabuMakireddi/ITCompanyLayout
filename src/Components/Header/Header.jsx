          ...
          <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
              <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                  ...
                  <div
                      ...
                      id="mobile-menu-2"
                  >
                    <div onClick={()=>setIsActive(!isActive)} className={`lg:hidden sm:block`}>=</div>
                      <ul className={`visible  flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 ${isActive ? 'visible' : 'hidden'}`}>
